package com.example.saaibi.parcial.Firebase;
...
import com.example.saaibi.parcial.Views.PushNotificationsActivity;
...
public class FCMService extends FirebaseMessagingService {
    ...
    private void sendNewPromoBroadcast(RemoteMessage remoteMessage) {
        Intent intent = new Intent(PushNotificationsActivity.ACTION_NOTIFY_NEW_PROMO);
